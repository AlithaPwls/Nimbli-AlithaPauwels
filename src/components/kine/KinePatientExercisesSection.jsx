    ...
    <section className="rounded-[14px] border-2 border-[#e1dbd3] bg-white px-8 pb-8 pt-8 shadow-[0_2px_0_0_#e1dbd3]">
      <header>
        <div className="flex flex-wrap items-center justify-between gap-3">
          <h2 className="font-nimbli-heading text-[22px] font-bold text-[#1a1a1a]">Oefeningen</h2>
          <Button
            type="button"
            disabled={addExerciseDisabled || !onAddExercise}
            onClick={onAddExercise}
            className="h-11 shrink-0 rounded bg-nimbli font-nimbli-heading text-sm font-black text-white shadow-[0_2px_0_0_#1e7a6a] hover:bg-nimbli/90 disabled:opacity-60"
          >
            <Plus className="mr-2 size-[18px]" aria-hidden />
            Oefening toevoegen
          </Button>
        </div>
        <p className="mt-1 text-[15px] text-nimbli-muted">Toegewezen aan {patientName}</p>
      </header>
