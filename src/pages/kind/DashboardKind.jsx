...
export default function DashboardKind() {
  ...
  return (
    ...
    >
      <KindOverviewStats className="fixed right-4 top-[calc(3.5rem+env(safe-area-inset-top,0px)+0.5rem)] z-30 max-lg:flex lg:hidden" />
      <div className="flex w-full min-w-0 flex-1 flex-col items-stretch px-4 pt-4 max-lg:pb-2 lg:justify-start lg:px-8 lg:pt-8 xl:px-10">
        <KindProgressPath />
      </div>
      <div className="flex justify-end border-t border-[#e5e7eb] px-4 py-6 max-lg:px-4 max-lg:py-5 lg:hidden">
