...
Allowed landmark names (use these strings exactly, case-sensitive):
...
export function buildSystemPrompt(): string {
  return [
    ...
    'Prefer simple, robust rules (visibility + 2-3 geometric checks). Avoid over-constraining.',
    'Use small `delta` / tolerance values (e.g. 0.04-0.06) consistent with the example.',
    '',
    SCHEMA_DOC,
    '',
    EXAMPLE,
...
function compactLandmarks(snap: Snapshot): Array<Record<string, number | string>> {
